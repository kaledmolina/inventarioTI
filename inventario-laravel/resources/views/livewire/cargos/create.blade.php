<div>
    ...
    <div class="card col-md-8 mx-auto">
        <div class="card-header bg-white py-3">
            <h5 class="mb-0 text-primary fw-bold">Información del Cargo</h5>
        </div>
        <div class="card-body p-4">
            <form wire:submit="save">
                ...
                <div class="mb-3">
                    <label class="form-label fw-bold">Área Perteneciente <span class="text-danger">*</span></label>
                    <select class="form-select @error('id_area') is-invalid @enderror" wire:model="id_area">
