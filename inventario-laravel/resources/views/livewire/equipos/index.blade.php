<div>
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input wire:model.live.debounce.300ms="codigo_inventario" type="text"
                        class="form-control form-control-sm">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Número de Serie</label>
                    <input wire:model.live.debounce.300ms="numero_serie" type="text"
                        class="form-control form-control-sm">
                </div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('equipos.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle me-2"></i>
                Registrar Nuevo Equipo</a>
        </div>
        <div class="card-body">
                            ...
                            @endphp
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <button class="btn btn-primary btn-sm" title="Ver Detalle"><i
                                                                class="bi bi-eye-fill"></i></button>
                                                        <a href="{{ route('equipos.edit', $equipo->id) }}" class="btn btn-warning btn-sm"
                                                            title="Editar Equipo"><i class="bi bi-pencil-fill"></i></a>

                                                        @if($equipo->estado === 'Disponible')
                                                            <a href="{{ route('reparaciones.create', $equipo->id) }}"
                                                                class="btn btn-info btn-sm" title="Enviar a Reparación"><i
                                                                    class="bi bi-wrench"></i></a>
                                                        @endif

                                                        @if($equipo->estado !== 'Asignado' && $equipo->estado !== 'De Baja')
                                                            <a href="{{ route('bajas.create', $equipo->id) }}" class="btn btn-danger btn-sm"
                                                                title="Dar de Baja"><i class="bi bi-trash-fill"></i></a>
                                                        @endif
                                                    </div>
                                                </td>
                                            </tr>
