                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('codigo_inventario') is-invalid @enderror"
                            wire:model="codigo_inventario" placeholder="Ej: INV-001" required>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control @error('numero_serie') is-invalid @enderror"
                            wire:model="numero_serie" placeholder="Ingrese el número de serie">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('caracteristicas') is-invalid @enderror"
                            wire:model="caracteristicas" placeholder="Ej: Core i5, 16GB RAM...">
