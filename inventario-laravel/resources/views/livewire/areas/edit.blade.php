<div>
    ...
    <div class="card col-md-8 mx-auto">
        <div class="card-header bg-white py-3">
            <h5 class="mb-0 text-primary fw-bold">Información del Área</h5>
        </div>
        <div class="card-body p-4">
            <form wire:submit="save">
                <div class="mb-3">
                    <label class="form-label fw-bold">Nombre del Área <span class="text-danger">*</span></label>
